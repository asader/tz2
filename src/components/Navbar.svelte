...
<div class="flex relative h-16 bg-white border-b border-gray-200">
    <button
    ...
    <div class="flex flex-1 justify-between sm:px-6 lg:max-w-6xl lg:mx-auto lg:px-8">
        <Search />

        <button class="px-4 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none"> Log out </button>
    </div>
</div>
